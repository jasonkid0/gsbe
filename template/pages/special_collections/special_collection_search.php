...
-->
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">Search Special Collections</h4>
                      ...
                      <tr>
                        ...
                        <?php if($_SESSION['role'] == "Administrator"){ ?>   
                          <td>
                                <a class="btn btn-primary" for="ViewAdmin" href="edit_special_collection.php<?php echo '?thesis_id='.$id; ?>">
                                <i class="fa fa-edit"></i> Edit
                                </a><br>
                                <a class="btn btn-success" for="ViewAdmin" href="archive_special_collection.php<?php echo '?thesis_id='.$id; ?>">
                              ...
                              <div class="modal-dialog">
                                  ...
                                  <div class="modal-header">
                                      <h4 style="font-weight: bold" class="modal-title" id="myModalLabel"><i class="fa fa-book"></i> Delete Special Collection</h4>
                              ...
                              <div class="modal-footer">
                                  ...
                                  <a href="delete_special_collection.php<?php echo '?thesis_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-danger"><i class="fa fa-trash"></i> Yes</a>
                                </div>
                                </div>
                                </div>
                                </div>
