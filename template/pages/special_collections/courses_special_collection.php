            ...
            <div class="content-wrapper">
              <div class="row">
                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                          <label for="category">Course<span class="required" style="color:red;">*</span></label>
                          <input name="cour" type="text" class="form-control" id="category" required="required" placeholder="--Input Course--">
                        </div>
                        <center>
                ...
                if (isset($_POST['submit'])) {
                  $subject = mysqli_real_escape_string($con,$_POST['cour']);
                  ...
                  $row=mysqli_num_rows($result);
                    if ($row > 0){
                      ...
                      echo "<script>alert('Course successfully added!'); window.location='courses_special_collection.php'</script>";
                    }
                }       
                ?>
                                  ...
                                  <?php echo $row['course_name']; ?></td>
                                      ...
                                      <a class="btn btn-primary" for="ViewAdmin" href="#edit<?php echo $id;?>" data-bs-toggle="modal" data-bs-target="#edit<?php echo $id;?>">
                                        ...
                                        <div class="modal fade" id="edit<?php  echo $id;?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                          <div class="modal-dialog">
                                              ...
                                              <div class="modal-header">
                                                  <h4 style="font-weight: bold" class="modal-title" id="myModalLabel"><i class="fa fa-book"></i> Edit Course</h4>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                              </div>
                                          <div class="modal-body">
                                              <div class="alert alert-primary">
                                                <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" action="edit_course.php<?php echo '?course_id='.$id; ?>">
                                                  <div class="form-group">
                                                    <label class="control-label" for="tbl_subjects">Mode of Acquisition <span class="required" style="color:red;">*</span>
                                                    </label>
                                                    <div class="">
                                                      <?php echo '
                                                          <input type="text" name="cour1" id="edit<?php  echo $id;?>" required="required" class="form-control" value="'.htmlspecialchars($row['course_name']).'">';
                                                      ?>
                                                    </div>
                                                  </div>
                                              </div>
                                          <div class="modal-footer">
                                              ...
                                              <a href="edit_course.php<?php echo '?course_id='.$id; ?>"><button type="submit" name="submit1" style="margin-bottom:5px;" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button></a>
                                              </form>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 style="font-weight: bold" class="modal-title" id="myModalLabel"><i class="fa fa-folder"></i> Delete Course</h4>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                        <div class="modal-body">
                                            <div class="alert alert-danger"> <center>
                                              <p class="text-truncate">Are you sure you want to delete <br><?php echo $row['course_name']; ?>? </p></center>
                                            </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light" data-bs-dismiss="modal" aria-hidden="true">No</button>
                                            <a href="delete_course.php<?php echo '?course_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-danger"><i class="fa fa-trash"></i> Yes</a>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
