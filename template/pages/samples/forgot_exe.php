...
require('../../../template/pages/admin/phpmailer/PHPMailerAutoload.php');
...
try {
    ...
    //Content
    $mail->AddEmbeddedImage('../../../template/images/logo.png', 'logosfac');
...
<body>
    ...
    font-size: 16px;"><a href="http://localhost/gsbe/template/pages/samples/reset_pass.php?username='.$username.'&activation_code='.$code.'" style="font-size: 25px; padding: 10px;text-decoration: none;color: white">Choose a new password</a></button></center>
        <br>
